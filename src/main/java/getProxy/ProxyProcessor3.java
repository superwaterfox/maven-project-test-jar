 ...
 */
public class ProxyProcessor3 implements PageProcessor {
	// 部分一：配置网站的相关配置，包括头部信息，抓取间隔，重试次数等
	private Site site = Site.me().setRetryTimes(3).setTimeOut(2000).setSleepTime(10).addHeader("User-Agent",
	...
	public static void main(String[] args) {
		// 国内高匿
		Spider.create(new ProxyProcessor3()).addUrl("http://www.proxy360.cn/default.aspx").// 入口处
				thread(5).run();// 入口处
